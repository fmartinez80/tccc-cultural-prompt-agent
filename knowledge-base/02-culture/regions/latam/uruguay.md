...
- **Table setting is broadly European/Continental in formal contexts**: bread is placed directly on the tablecloth rather than on a separate bread plate; Continental style is used (fork in left hand, knife in right); hands stay visible above the table; utensils are placed parallel, tines north, to signal "finished." [CONFIDENCE: MEDIUM] [SOURCE: [Etiquette Scholar — Uruguay Dining Etiquette](https://www.etiquettescholar.com/dining_etiquette/table-etiquette/sa_table_manners/uruguayan.html)]
...
- Primary starch/accompaniment: Bread bun (buttered, toasted)
...
- Sources: [Guru'Guay — history of the chivito](https://www.guruguay.com/uruguay-chivito/); [The Culture Trip](https://theculturetrip.com/south-america/uruguay/articles/a-brief-history-of-uruguays-chivito); [Wikipedia: Chivito (sandwich)](https://en.wikipedia.org/wiki/Chivito_(sandwich)); [Where Is My Spoon — Choripán](https://whereismyspoon.co/choripan-chorizo-and-chimichurri-sandwich-uruguayan-food/)

#### Dish: Milanesa (al pan / a la napolitana)
- Category: Everyday
- Primary protein: Thin breaded, pan-fried beef cutlet (schnitzel-style)
- Primary starch/accompaniment: As "milanesa al pan"/"refuerzo de milanesa" — a white baton/short baguette; as "napolitana" — served plated, no bread
...
- Sources: [Canal26 — vecinas pero diferentes](https://www.canal26.com/recetas/2026/05/09/vecinas-pero-diferentes-el-detalle-culinario-que-separa-a-la-milanesa-uruguaya-de-la-argentina/); [Jamón y Eso](https://jamonyeso.uy/milanesa-napolitana-la-preferida-de-los-uruguayos/); [Wikipedia (ES): Milanesa napolitana](https://es.wikipedia.org/wiki/Milanesa_napolitana)
...
- Primary starch/accompaniment: Bread roll, when served as choripán
...
- Sources: [Select Latin America](https://www.selectlatinamerica.co.uk/uruguay/guide-uruguayan-food/); [Wikipedia: Choripán](https://en.wikipedia.org/wiki/Chorip%C3%A1n); [ArgentineAsado.com — Morcilla](https://argentineasado.com/morcilla/)
...
- **Total sources consulted:** ~40 search queries returning distinct source sets; approximately 30 unique sources were directly cited above.
- **Sources used and their general type:**
  - Long-form travel/food journalism: The Culture Trip, Guru'Guay, National Geographic (found via search, not directly fetched — see note below), Saveur, italiani.it
  - Encyclopedic/reference: Wikipedia (English and Spanish) — Uruguayan cuisine, Cuisine of Montevideo, Chivito (sandwich), Puchero, Choripán, Milanesa napolitana, Chajá (postre)
  - Dedicated cultural/etiquette reference: Etiquette Scholar (Uruguay Dining Etiquette)
  - Uruguayan local food-culture sites: cocina-uruguaya.com, Cocina del Uruguay (blog), Descubrí Montevideo, Montevideo Gastronómico, Tuti Fruti, Jamón y Eso, amec.com.uy, todouruguay.net, somosdeaca.uy
  - Uruguayan/regional news with cultural-history angle: Canal26, SWI swissinfo.ch, LARED21
  - Specialist/topical blogs: La Gran Uruguaya, Bodega Garzón, Shared Soup (Substack), Heretic Yerba, Barry's Borderpoints, Scoolinary, The Argentine Asado
